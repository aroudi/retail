/**This code is heavily based on the $loadDialog service in angular-jqm version 1.1.5 authored by Andy Joslin:https://github.com/ajoslinAuthored by: Corbyn Salisbury: https://github.com/corbyns**/
    ...
    .service('loadDisplay', ['$rootElement', '$q', 'loadTemplate', function($rootElement, $q, loadTemplate) {
        ...
        function displayTop() {
            for(var i = 0; i < _PromiseStack.length; i++) {
                ...
                var template = _Promises[topId].template;      //hide any loading dialogs being displayed in the children
...
angular.module('loadDisplay').value('loadTemplate',  "<div id='load-background' class='hide-background'>" +    "<div class='loading-display'>"+      "<img src='images/ajax-loader.gif' height='60' width='60'><br><span>Loading</span></div>"+    "</div>"+  "</div>");