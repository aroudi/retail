 ...
 */
cimgApp.controller('purchaseOrderListCtrl', function($scope, $state, uiGridConstants, ngDialog, purchaseOrderService, $timeout,UserService,baseDataService, SUCCESS, FAILURE, POH_GET_ALL_URI, POH_GET_URI, DEL_NOTE_GET_URI, POH_SEARCH_URI, POH_EXPORT_PDF, POH_SEARCH_PAGING_URI, SUPPLIER_ALL_URI, POH_STATUS_URI, POH_CREATION_TYPE_URI, POH_DELETE_URI, TAXLEGVARIANCE_ALL_URI) {
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [
            ...
            {field:'pohExpDelivery', displayName:'Expected',enableCellEdit:false, width:'8%', cellFilter:'date:\'dd/MM/yyyy HH:mm\''},
            ...
            {field:'pohCreationType', displayName:'Generated',enableCellEdit:false, width:'8%', cellFilter:'configCategoryFilter',
    ...
    */
    ...
    $scope.createPurchaseOrder = function () {
        ...
        if (!UserService.checkUserHasAccess("purchaseOrderDetail")) {
            baseDataService.displayMessage("info", "Access is denied!!", "You don't have access for creating purchase order");
            return;
        }
        $state.go('dashboard.purchaseOrderDetail', {blankPage:'true'});
