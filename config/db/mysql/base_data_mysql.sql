...
INSERT INTO CONFIG_TYPE(CONFIG_CODE, DISPLAY_NAME, DESCRIPTION) VALUES ('COMPANY_TYPE', 'COMPANY TYPES', 'COMPANY TYPES');
;

INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION, CATEGORY_ORDER) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='COMPANY_TYPE'),'COMPANY_TYPE_GROCERY', 'GROCERY', 'GROCER STORE', 1);
;
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION, CATEGORY_ORDER) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='COMPANY_TYPE'),'COMPANY_TYPE_RESTAURANT', 'RESTAURANT', 'RESTAURANT', 1);
;
...
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='PRODUCT_STATUS'),'PROD_STATUS_FINALISED', 'FINALISED', 'FINALISED');
;

INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='PRODUCT_STATUS'),'PROD_STATUS_IN_REVIEW', 'IN REVIEW', 'IN REVIEW');
;


##CASH SESSION TYPES

INSERT INTO CONFIG_TYPE(CONFIG_CODE, DISPLAY_NAME, DESCRIPTION) VALUES ('CASH_SESSION_TYPE', 'CASH SESSION TYPES', 'CASH SESSION TYPES');
;


INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='CASH_SESSION_TYPE'),'SESSION_PER_USER', 'SESSION PER USER', 'SESSION PER USER');
;

INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='CASH_SESSION_TYPE'),'SESSION_PER_COMPANY', 'SESSION PER COMPANY', 'SESSION PER COMPANY');
;
---------------------------------------------------------
...
INSERT INTO UNIT_OF_MEASURE(UNOM_CODE, UNOM_DESC, UNOM_FACTOR, UNOM_ID_PARENT, UNOM_CREATED, UNOM_MODIFIED) VALUES ('EA', 'Each', 1, null, SYSDATE(), SYSDATE());
;

INSERT INTO UNIT_OF_MEASURE(UNOM_CODE, UNOM_DESC, UNOM_FACTOR, UNOM_ID_PARENT,UNOM_CREATED, UNOM_MODIFIED) VALUES ('kg', 'kiloo', 1, null,SYSDATE(),SYSDATE());
;


INSERT INTO UNIT_OF_MEASURE(UNOM_CODE, UNOM_DESC, UNOM_FACTOR, UNOM_ID_PARENT,UNOM_CREATED, UNOM_MODIFIED) VALUES ('gram', 'gram', 1000, 1, SYSDATE(),SYSDATE());
;

INSERT INTO UNIT_OF_MEASURE(UNOM_CODE, UNOM_DESC, UNOM_FACTOR, UNOM_ID_PARENT,UNOM_CREATED, UNOM_MODIFIED) VALUES ('mg', 'miligram', 1000, 2,SYSDATE(),SYSDATE() );
;

INSERT INTO UNIT_OF_MEASURE(UNOM_CODE, UNOM_DESC, UNOM_FACTOR, UNOM_ID_PARENT,UNOM_CREATED, UNOM_MODIFIED) VALUES ('liter', 'liter', 1, null,SYSDATE(),SYSDATE());
;
...
INSERT INTO PRICE_CODE (PRCC_NAME, PRCC_CODE, PRCC_CREATED) VALUES ('SELL PRICE', 'SELL_PRICE', SYSDATE());
;

INSERT INTO PRICE_CODE (PRCC_NAME, PRCC_CODE, PRCC_CREATED) VALUES ('COST PRICE', 'COST_PRICE', SYSDATE());
;

INSERT INTO STORE(ORGU_ID, STORE_CODE,STORE_NAME, CASH_SESSION_TYPE) values ((SELECT ORGU_ID FROM ORG_UNIT WHERE ORGU_CODE='JOMON'), 'JOMON_SYD','JOMON SYDNEY STORE' , (SELECT CATEGORY_ID FROM CONFIG_CATEGORY WHERE CATEGORY_CODE = 'SESSION_PER_COMPANY'));
;
...
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION, COLOR) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='TXN_TYPE'),'TXN_TYPE_SALE', 'SALE ORDER', 'TRANSACTION SALE ORDER', 'blue');
;
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION, COLOR) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='TXN_TYPE'),'TXN_TYPE_REFUND', 'REFUND', 'TRANSACTION REFUND', 'red');
;
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION, COLOR) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='TXN_TYPE'),'TXN_TYPE_QUOTE', 'QUOTE', 'QUOTE','yellow');
;
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION, COLOR) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='TXN_TYPE'),'TXN_TYPE_INVOICE', 'INVOICE', 'INVOICE', 'green');
;
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION, COLOR) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='TXN_TYPE'),'TXN_TYPE_BOQ', 'BOQ', 'BOQ','purple');
;
...
;
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='TXN_TYPE'),'TXN_TYPE_REVERSE_ACC_PAYMENT', 'REVERSE ACCOUNT PAY', 'REVERSE ACCOUNT PAYMENT'); ##FOR RECORDING REVERSAL DEBTOR PAYMENT
;
...
;
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='TXN_TYPE'),'TXN_TYPE_CHANGE_IN_COST', 'CHANGE IN COST', 'CHANGE IN COST');
;
...
;
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='TXN_MEDIA_TYPE'),'TXN_MEDIA_INVOICE', 'INVOICE', 'TRANSACTION MEDIA PAID FOR INVOICE');
;
...
;
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='TXN_MEDIA_TYPE'),'TXN_MEDIA_DEPOSIT_REFUNDED', 'DEPOSIT', 'TRANSACTION MEDIA DEPOSIT REFUNDED');
;
...
##TRANSACTION STATUS
INSERT INTO CONFIG_TYPE(CONFIG_CODE, DISPLAY_NAME, DESCRIPTION) VALUES ('TXN_STATUS', 'TXN_STATUS', 'TRANSACTION STATUS');
;

INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION, COLOR) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='TXN_STATUS'),'TXN_STATUS_REFUNDED', 'REFUNDED', 'TRANSACTION IS REFUNDED', 'amber');
;
...
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION, COLOR) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='BOQ_STATUS'),'BOQ_STATUS_NEW', 'PENDING', 'PENDING','red');
;

INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION, COLOR) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='BOQ_STATUS'),'BOQ_STATUS_CONFIRMED', 'CONFIRMED', 'CONFIRMED','amber');
;
...
INSERT INTO ACCESS_POINT (ACPT_NAME, ACPT_TOKEN,ACPT_DESC) VALUES ('Reverse Debtor Payment', 'reverseDebtorPayment', 'Reverse Debtor Payment');
INSERT INTO ACCESS_POINT (ACPT_NAME, ACPT_TOKEN,ACPT_DESC) VALUES ('Product Group Management', 'productGroupTreeView', 'Product Group Management');
INSERT INTO ACCESS_POINT (ACPT_NAME, ACPT_TOKEN,ACPT_DESC) VALUES ('Reporting', 'reporting', 'Reporting');
;


INSERT INTO APP_USER (USR_NAME, USR_PASS, USR_FIRST_NAME, USR_SUR_NAME, USR_ACTIVE, USR_DELETED) VALUES ('Admin', 'C1C224B03CD9BC7B6A86D77F5DACE40191766C485CD55DC48CAF9AC873335D6F', 'Administrator', 'Administrator', 1, 0 );
...
INSERT INTO USER_ACCESS(USR_ID, ACPT_ID) VALUES ( (select USR_ID from APP_USER WHERE USR_NAME = 'Admin'), (select ACPT_ID FROM ACCESS_POINT WHERE ACPT_TOKEN = 'reverseDebtorPayment' ));
INSERT INTO USER_ACCESS(USR_ID, ACPT_ID) VALUES ( (select USR_ID from APP_USER WHERE USR_NAME = 'Admin'), (select ACPT_ID FROM ACCESS_POINT WHERE ACPT_TOKEN = 'productGroupTreeView' ));
INSERT INTO USER_ACCESS(USR_ID, ACPT_ID) VALUES ( (select USR_ID from APP_USER WHERE USR_NAME = 'Admin'), (select ACPT_ID FROM ACCESS_POINT WHERE ACPT_TOKEN = 'reporting' ));
;
------------------------ STOCK TYPE -------------------
...
;
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='SESSION_EVENT_TYPE'),'SESSION_EVENT_TYPE_ACC_REFUND', 'REVERSE DEBTOR PAYMENT', 'REVERSE DEBTOR PAYMENT');
;
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='SESSION_EVENT_TYPE'),'SESSION_EVENT_TYPE_CHANGE_IN_COST', 'CHANGE IN COST', 'change in cost');
;
...
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='TYPE_JOURNAL_ACTION'),'JA_CHANGE_IN_COST', 'CHANGE IN COST', 'CHANGE IN COST');
;
## ACCOUNTS
...
INSERT INTO JOURNAL_RULE (ORGU_ID, TXN_TYPE, JRNR_ACTION, ACC_ID, JRNR_ACC_CODE, JRNR_ACC_DESC, JRNR_DEBIT, JRNR_CREDIT )
VALUES ((SELECT ORGU_ID FROM ORG_UNIT WHERE ORGU_CODE='JOMON'),
        (SELECT CATEGORY_ID FROM CONFIG_CATEGORY WHERE CATEGORY_CODE = 'TXN_TYPE_CHANGE_IN_COST'),
        (SELECT CATEGORY_ID FROM CONFIG_CATEGORY WHERE CATEGORY_CODE = 'JA_CHANGE_IN_COST'),
        (SELECT ACC_ID FROM ACCOUNT WHERE ACC_NAME = 'LAST_COST_VARIANCE'),
        '55000',
        'Last Cost Variance',
        0,
        1
...
VALUES ((SELECT ORGU_ID FROM ORG_UNIT WHERE ORGU_CODE='JOMON'),
        (SELECT CATEGORY_ID FROM CONFIG_CATEGORY WHERE CATEGORY_CODE = 'TXN_TYPE_CHANGE_IN_COST'),
        (SELECT CATEGORY_ID FROM CONFIG_CATEGORY WHERE CATEGORY_CODE = 'JA_CHANGE_IN_COST'),
        (SELECT ACC_ID FROM ACCOUNT WHERE ACC_NAME = 'INVENTORY'),
        '11400',
        'Inventory Adjustment',
        1,
        0
...
INSERT INTO DEPARTMENT (DEPT_NAME, DEPT_CODE, DEPT_DESC) VALUES ('Default', 'Default', 'Default department')
;

## category types
INSERT INTO CONFIG_TYPE(CONFIG_CODE, DISPLAY_NAME, DESCRIPTION) VALUES ('PROD_CAT_TYPE', 'PRODUCT CATEGORY TYPE', 'PRODUCT CATEGORY TYPE');
;

INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION, CATEGORY_ORDER) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='PROD_CAT_TYPE'),'PROD_CAT_1', 'Category 1', 'Category 1', 1);
;
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION, CATEGORY_ORDER) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='PROD_CAT_TYPE'),'PROD_CAT_2', 'Category 2', 'Category 2', 2);
;
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION, CATEGORY_ORDER) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='PROD_CAT_TYPE'),'PROD_CAT_3', 'Category 3', 'Category 3', 3);
;


## reports

insert into REPORT_GROUP(REP_GRP_NAME, DISPLAY_ORDER) VALUES ('Sales', 1);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (1, 'ACCOUNT_SALES', 'Account Sales', 1);

insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (1,'Date', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (1,'DateFrom', '','INVOICE.TXIV_TRADING_DATE', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (1,'DateTo', '','INVOICE.TXIV_TRADING_DATE', 2);

insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (1,'SortBy', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (2,'Customer', '', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (2,'Invoice No.', '', 2);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (2,'Invoice Date','', 3);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (2,'Stock Barcode','', 4);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (2,'Tax Code', '', 5);


insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (1, 'SALES_BY_MONTH','Sales by Month', 2);
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (2,'Supplier', 'supplier.supplier_id');
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (2,'Date', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (4,'DateFrom', '','INVOICE.TXIV_TRADING_DATE', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (4,'DateTo', '','INVOICE.TXIV_TRADING_DATE', 2);


insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (1,'SALES_BY_TAX_CODE', 'Sales by Tax Codes', 3);
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (3,'Date', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (5,'DateFrom', '','INVOICE.TXIV_TRADING_DATE', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (5,'DateTo', '','INVOICE.TXIV_TRADING_DATE', 2);

insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (1,'SALES_BY_TAX_CODE_SUMMARY','Sales by Tax Codes Summary', 4);
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (4,'Date', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (6,'DateFrom', '','INVOICE.TXIV_TRADING_DATE', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (6,'DateTo', '','INVOICE.TXIV_TRADING_DATE', 2);

insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (1, 'SALES_DAILY', 'Sales Daily', 5);
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (5,'Date', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (7,'DateFrom', '','INVOICE.TXIV_TRADING_DATE', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (7,'DateTo', '','INVOICE.TXIV_TRADING_DATE', 2);

insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (5,'GroupBy', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (8,'None', '', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (8,'Staff', 'APP_USER.USR_ID', 2);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (8,'Customer','CUSTOMER.Company_Name', 3);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (8,'Docket No','INVOICE.TXIV_ID', 4);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (8,'Cash Drawer', '', 5);



insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (1,'SALES_PERIOD', 'Sales Period', 6);
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (6,'Date', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (9,'DateFrom', '','INVOICE.TXIV_TRADING_DATE', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (9,'DateTo', '','INVOICE.TXIV_TRADING_DATE', 2);

insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (6,'GroupBy', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (10,'None', '', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (10,'Department', 'deptName', 2);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (10,'Category 1','PROD_CAT_1', 3);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (10,'Category 2','PROD_CAT_2', 4);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (10,'Category 3', 'PROD_CAT_3', 5);
##insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (6,'SortBy', '');
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (6,'Category', 'PRODUCT_GROUP.CAT_VAL_ID');

##insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (1,'SALES_PERIOD_AVG', 'Sales Period Avg', 7);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (1,'WHAT_IS_SELLING', 'What is selling', 8);
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (7,'Date', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (12,'DateFrom', '','INVOICE.TXIV_TRADING_DATE', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (12,'DateTo', '','INVOICE.TXIV_TRADING_DATE', 2);

insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (7,'GroupBy', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (13,'None', '', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (13,'Department', 'deptName', 2);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (13,'Category 1','PROD_CAT_1', 3);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (13,'Category 2','PROD_CAT_2', 4);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (13,'Category 3', 'PROD_CAT_3', 5);
##insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (6,'SortBy', '');
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (7,'Category', 'PRODUCT_GROUP.CAT_VAL_ID');

insert into REPORT_GROUP(REP_GRP_NAME, DISPLAY_ORDER) VALUES ('Profit', 2);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (2,'PROFIT_BY_PRODUCT', 'Profit By Product', 1);
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (8,'Date', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (15,'DateFrom', '','INVOICE.TXIV_TRADING_DATE', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (15,'DateTo', '','INVOICE.TXIV_TRADING_DATE', 2);

insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (8,'GroupBy', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (16,'None', '', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (16,'Department', 'deptName', 2);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (16,'Category 1','PROD_CAT_1', 3);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (16,'Category 2','PROD_CAT_2', 4);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (16,'Category 3', 'PROD_CAT_3', 5);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (16,'Supplier', 'supplierName', 6);
##insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (6,'SortBy', '');
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (8,'Category', 'PRODUCT_GROUP.CAT_VAL_ID');

##insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (2,'PROFIT_BY_CATEGORY', 'Profit By Category', 2);
##insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (2,'PROFIT_BY_CATEGORY_SUMMARY', 'Profit By Category Summary', 3);
##insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (2,'PROFIT_BY_CUSTOM' ,'Profit By Custom', 4);
##insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (2,'SALES_BY_CUSTOM_SUMMARY', 'Sales By Custom Summary', 5);
##insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (2,'PROFIT_BY_SUPPLIER', 'Profit By Supplier', 6);
##insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (2,'PROFIT_BY_SUPPLIER_SUMMARY', 'Profit By Supplier Summary', 7);


insert into REPORT_GROUP(REP_GRP_NAME, DISPLAY_ORDER) VALUES ('Stock', 3);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (3,'PRICE_BY_GRADE', 'Prices By Grade', 1);
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (9,'GroupBy', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'None', '', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'Category 1','PROD_CAT_1', 3);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'Category 2','PROD_CAT_2', 4);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'Supplier', 'supplierName', 6);
##insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (9,'SortBy', '');
##insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'SKU', 'prodSku', 1);
##insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'Product Name', 'prodName', 2);
##insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'Cost','prodCost', 3);
##insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'Quantity','qtyAvailable', 4);
##insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'RRP Price', 'rrp', 5);
##insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'RRP GP%', 'rrpGp', 6);
##insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'Default Grade Price', 'defaultGrade', 7);
##insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'Default Grade GP%', 'defaultGradeGp', 8);
##insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'A Grade Price', 'aGrade', 9);
##insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'A Grade GP%', 'aGradeGp', 10);
##insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'B Grade Price', 'bGrade', 11);
##insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'B Grade GP%', 'bGradeGp', 12);
##insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'C Grade Price', 'cGrade', 13);
##insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'C Grade GP%', 'cGradeGp', 14);
##insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'D Grade Price', 'dGrade', 15);
##insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (18,'D Grade GP%', 'dGradeGp', 16);
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (9,'Category', 'PRODUCT_GROUP.CAT_VAL_ID');
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (9,'Supplier', 'supplier.supplier_id');
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (3,'GOODS_RECEIVED', 'Goods Received', 2);
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (10,'Date', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (21,'DateFrom', '','DELIVERY_NOTE_HEADER.DELN_CREATED_DATE', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (21,'DateTo', '','DELIVERY_NOTE_HEADER.DELN_CREATED_DATE', 2);

insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (3,'WHAT_IS_IN_STOCK', 'What is in stock', 3);

insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (11,'GroupBy', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (22,'None', '', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (22,'Department', 'deptName', 2);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (22,'Category 1','PROD_CAT_1', 3);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (22,'Category 2','PROD_CAT_2', 4);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (22,'Category 3', 'PROD_CAT_3', 5);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (22,'Supplier', 'supplierName', 6);
##insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (6,'SortBy', '');
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (11,'Category', 'PRODUCT_GROUP.CAT_VAL_ID');
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (11,'Supplier', 'supplier.supplier_id');

insert into REPORT_GROUP(REP_GRP_NAME, DISPLAY_ORDER) VALUES ('Supplier', 4);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (4,'WHAT_IS_ON_ORDER', 'What is on order', 4);

insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (12,'GroupBy', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (25,'None', '', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (25,'Department', 'deptName', 2);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (25,'Category 1','PROD_CAT_1', 3);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (25,'Category 2','PROD_CAT_2', 4);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (25,'Category 3', 'PROD_CAT_3', 5);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (25,'Supplier', 'supplierName', 6);
##insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (6,'SortBy', '');
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (12,'Category', 'PRODUCT_GROUP.CAT_VAL_ID');
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (12,'Supplier', 'supplier.supplier_id');
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (12,'Date', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (28,'DateFrom', '','PURCHASE_ORDER_HEADER.POH_EXP_DELIVERY', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (28,'DateTo', '','PURCHASE_ORDER_HEADER.POH_EXP_DELIVERY', 2);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (4,'SUPPLIER_LIST', 'Supplier List', 5);

insert into REPORT_GROUP(REP_GRP_NAME, DISPLAY_ORDER) VALUES ('Staff', 5);
insert into REPORT_GROUP(REP_GRP_NAME, DISPLAY_ORDER) VALUES ('Customer', 6);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (6,'DEBTORS', 'Debtors', 2);
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (14,'Date', '');
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (29,'DateTo', '','INVOICE.TXIV_TRADING_DATE', 1);
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (14,'Customer', 'Customer.customer_id');
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (6,'CUSTOMER_LIST', 'Customer List', 3);

insert into REPORT_GROUP(REP_GRP_NAME, DISPLAY_ORDER) VALUES ('Payments', 7);
;
commit;
