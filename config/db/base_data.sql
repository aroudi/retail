...
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (7,'None', '', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (7,'Staff', '', 2);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (7,'Customer','', 3);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (7,'Docket No','', 4);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (7,'Cash Drawer', '', 5);
...
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (8,'DateFrom', '','', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (8,'DateTo', '','', 2);
