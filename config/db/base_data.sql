...
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, DISPLAY_ORDER) VALUES (1,'Account Sales', 1);
...
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, DISPLAY_ORDER) VALUES (1,'Sales by Month', 2);
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (2,'Supplier', '');


insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, DISPLAY_ORDER) VALUES (1,'Sales by Tax Codes', 3);
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (3,'Date', '');

insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, DISPLAY_ORDER) VALUES (1,'Sales by Tax Codes Summary', 4);
insert into REPORT_PARAM(REP_HEAD_ID, REP_PARAM_NAME, TABLE_ALIAS) VALUES (4,'Date', '');

insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, DISPLAY_ORDER) VALUES (1,'Sales Daily', 5);
...
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, DISPLAY_ORDER) VALUES (1,'Sales Period', 6);
...
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, DISPLAY_ORDER) VALUES (1,'Sales Period Avg', 7);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, DISPLAY_ORDER) VALUES (1,'What is selling', 8);

insert into REPORT_GROUP(REP_GRP_NAME, DISPLAY_ORDER) VALUES ('Profit', 2);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, DISPLAY_ORDER) VALUES (2,'Profit By Category', 1);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, DISPLAY_ORDER) VALUES (2,'Profit By Category Summary', 2);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, DISPLAY_ORDER) VALUES (2,'Profit By Custom', 3);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, DISPLAY_ORDER) VALUES (2,'Sales By Custom Summary', 4);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, DISPLAY_ORDER) VALUES (2,'Profit By Product', 5);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, DISPLAY_ORDER) VALUES (2,'Profit By Supplier', 6);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, DISPLAY_ORDER) VALUES (2,'Profit By Supplier Summary', 7);
