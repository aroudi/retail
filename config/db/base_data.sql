...
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='CASH_SESSION_TYPE'),'SESSION_PER_COMPANY', 'SESSION PER COMPANY', 'SESSION PER USER');
GO
