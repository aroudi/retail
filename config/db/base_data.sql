...
INSERT INTO CONFIG_CATEGORY(CONFIG_TYPE_ID, CATEGORY_CODE, DISPLAY_NAME, DESCRIPTION, COLOR) VALUES ((SELECT CONFIG_TYPE_ID FROM CONFIG_TYPE WHERE CONFIG_CODE='POH_CREATION_TYPE'),'POH_CREATION_TYPE_AUTO_SO', 'FROM SO', 'FROM SO','blue');
GO
