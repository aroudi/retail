...
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (1,'DateFrom', '','', 1);
insert into REPORT_PARAM_VAL(REP_PARAM_ID, REP_PARAM_KEY, REP_PARAM_VAL, TABLE_ALIAS,DISPLAY_ORDER) VALUES (1,'DateTo', '','', 2);
...
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (2,'PROFIT_BY_CATEGORY', 'Profit By Category', 1);

insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (2,'PROFIT_BY_CATEGORY_SUMMARY', 'Profit By Category Summary', 2);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (2,'PROFIT_BY_CUSTOM' ,'Profit By Custom', 3);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (2,'SALES_BY_CUSTOM_SUMMARY', 'Sales By Custom Summary', 4);
insert into REPORT_HEADING(REP_GRP_ID, REP_HEAD_NAME, REP_HEAD_TEXT, DISPLAY_ORDER) VALUES (2,'PROFIT_BY_PRODUCT', 'Profit By Product', 5);
