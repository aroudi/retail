...
CREATE TABLE COMPANY(
    ...
    COMP_USER_LICENCE DECIMAL(31,0) DEFAULT 1 NOT NULL,
    LCOUNT DECIMAL(31,0) DEFAULT 0 NOT NULL
) ON [PRIMARY]
go
...
CREATE TABLE STORE (
    ...
    CASH_SESSION_TYPE DECIMAL(31,0)
)
GO
CREATE TABLE TXN_HEADER (
    ...
    TXHD_STATUS DECIMAL(31,0), --PURCHASE ORDER STATUS
...
CREATE TABLE TXN_DETAIL (
    ...
    TXDE_STATUS DECIMAL(31,0) --PURCHASE ORDER STATUS
)
GO
...
CREATE TABLE STOCK_EVENT(
    ...
    TXN_DATE datetime,
    TXN_TYPE DECIMAL(31,0), -- EVENT TYPE
    ...
    TXN_ID_RESERVED_FOR DECIMAL(31,0),
    TXN_NR_RESERVED_FOR VARCHAR(200),
    TXN_ITEM_RESERVED_FOR DECIMAL(31,0),
    STCK_LOCN_ID DECIMAL(31,0),
    STCK_QTY DECIMAL(31,4) NOT NULL,
    SELL_PRICE DECIMAL(31,6),
