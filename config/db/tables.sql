...
ALTER TABLE DELIVERY_NOTE_LINE ADD CONSTRAINT DELIVERY_NOTE_LINE_FK4 FOREIGN KEY (DLNL_CASE_SIZE) REFERENCES UNIT_OF_MEASURE(DLNL_CASE_SIZE);
go

ALTER TABLE DELIVERY_NOTE_LINE ADD CONSTRAINT DELIVERY_NOTE_LINE_FK5 FOREIGN KEY (DLNL_PRODUCT_SIZE) REFERENCES UNIT_OF_MEASURE(DLNL_PRODUCT_SIZE);
go

ALTER TABLE DELIVERY_NOTE_LINE ADD CONSTRAINT DELIVERY_NOTE_LINE_FK6 FOREIGN KEY (RCVD_CASE_SIZE) REFERENCES UNIT_OF_MEASURE(RCVD_CASE_SIZE);
go

ALTER TABLE DELIVERY_NOTE_LINE ADD CONSTRAINT DELIVERY_NOTE_LINE_FK7 FOREIGN KEY (RCVD_PRODUCT_SIZE) REFERENCES UNIT_OF_MEASURE(RCVD_PRODUCT_SIZE);
go
