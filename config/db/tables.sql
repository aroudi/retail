...
CREATE TABLE TXN_DETAIL (
    ...
    TXDE_VALUE_NET DECIMAL(31,6),   --TXDE_VALUE_NET = TXDE_TAX*TXDE_VALUE_GROSS
...
ALTER TABLE TXN_DISCOUNT
 ADD  CONSTRAINT TXN_DISCOUNT_PK PRIMARY KEY(TXDI_ID);
GO
...
ALTER TABLE TXN_DISCOUNT ADD CONSTRAINT TXN_DISCOUNT_FK1 FOREIGN KEY (ORGU_ID) REFERENCES ORG_UNIT(ORGU_ID)
go


ALTER TABLE TXN_DISCOUNT ADD CONSTRAINT TXN_DISCOUNT_FK2 FOREIGN KEY (STORE_ID) REFERENCES STORE(STORE_ID)
go

ALTER TABLE TXN_DISCOUNT ADD CONSTRAINT TXN_DISCOUNT_FK3 FOREIGN KEY (TXHD_ID) REFERENCES TXN_HEADER(TXHD_ID)
go

ALTER TABLE TXN_DISCOUNT ADD CONSTRAINT TXN_DISCOUNT_FK4 FOREIGN KEY (TXDI_DISCOUNT_TYPE) REFERENCES CONFIG_CATEGORY(CATEGORY_ID)
go
