...
CREATE TABLE UNIT_OF_MEASURE(
    ...
    UNOM_CONSTANT DECIMAL(31,0) NOT NULL,
...
CREATE TABLE SELLING_CODE(
    SELC_ID DECIMAL(31,0) NOT NULL,
    PROD_ID DECIMAL(31,0) NOT NULL,
    ORGU_ID_LOC_CREATE DECIMAL(31,0),
    SELC_NAME VARCHAR(60),
    SELC_DESC VARCHAR(2048),
    SELC_CODE VARCHAR(60) NOT NULL,
    SELC_MASK VARCHAR(2048) NOT NULL,
    PUOS_ID DECIMAL(31,0),
    CAT_ID_STATUS DECIMAL(31,0) NOT NULL,
    SELC_CREATED datetime,
    SELC_MODIFIED datetime,
    LCOUNT DECIMAL(31,0) DEFAULT 0 NOT NULL
) ON [PRIMARY]
go
...
ALTER TABLE SELLING_CODE
 ADD  CONSTRAINT SELC_PK PRIMARY KEY(SELC_ID);
...
ALTER TABLE SELLING_CODE
 ADD  CONSTRAINT SELC_UK2 UNIQUE(SELC_CODE,PROD_ID);
GO

ALTER TABLE SELLING_CODE
 ADD  CONSTRAINT SELC_FK8 FOREIGN KEY(CAT_ID_STATUS) REFERENCES CONFIG_CATEGORY(CATEGORY_ID);

ALTER TABLE SELLING_CODE
 ADD  CONSTRAINT SELC_FK6 FOREIGN KEY(ORGU_ID_LOC_CREATE) REFERENCES ORG_UNIT(ORGU_ID);

ALTER TABLE SELLING_CODE
 ADD  CONSTRAINT SELC_FK3 FOREIGN KEY(PUOS_ID) REFERENCES PROD_UNIT_OF_SALE(PUOS_ID);

ALTER TABLE SELLING_CODE
 ADD  CONSTRAINT SELC_FK1 FOREIGN KEY(PROD_ID) REFERENCES PRODUCT(PROD_ID);


ALTER TABLE PRODUCT_METRIC ADD CONSTRAINT PRDM_FK1 FOREIGN KEY (SELC_ID) REFERENCES SELLING_CODE(SELC_ID)
go
...
ALTER TABLE PRICE ADD CONSTRAINT PRCE_FK6 FOREIGN KEY (SELC_ID) REFERENCES SELLING_CODE(SELC_ID)
go
