...
CREATE TABLE TXN_HEADER (
    ...
    TXHD_TXN_NR NUMERIC(10,0),
    TXHD_STATE DECIMAL(31,0),
    ORGU_ID_ORIGINAL DECIMAL(31,0),
    TXHD_ORIG_TXN_NR NUMERIC(10,0),
...
CREATE TABLE PURCHASE_LINE(
    ...
    POL_VALUE_ORDERED DECIMAL(31,6),
...
ALTER TABLE DELIVERY_NOTE_LINE ADD CONSTRAINT DELIVERY_NOTE_LINE_FK2 FOREIGN KEY (POL_ID) REFERENCES PURCHASE_LINE(POL_ID);
go
...
ALTER TABLE STOCK ADD CONSTRAINT STOCK_FK1 FOREIGN KEY (SUPPLIER_ID) REFERENCES SUPPLIER(SUPPLIER_ID);
go

ALTER TABLE STOCK ADD CONSTRAINT STOCK_FK2 FOREIGN KEY (PROD_ID) REFERENCES PRODUCT(PROD_ID);
go

ALTER TABLE STOCK ADD CONSTRAINT STOCK_FK3 FOREIGN KEY (PRGP_ID) REFERENCES PRODUCT_GROUP(PRGP_ID);
go
...
ALTER TABLE STOCK_EVENT ADD CONSTRAINT STOCK_EVENT_FK3 FOREIGN KEY (STORE_ID) REFERENCES STORE(STORE_ID);
go
...
ALTER TABLE STOCK_EVENT ADD CONSTRAINT STOCK_EVENT_FK6 FOREIGN KEY (PRGP_ID) REFERENCES PRODUCT_GROUP(PRGP_ID);
go

ALTER TABLE STOCK_EVENT ADD CONSTRAINT STOCK_EVENT_FK7 FOREIGN KEY (ORGU_ID) REFERENCES ORG_UNIT(ORGU_ID);
go
...
ALTER TABLE STOCK_EVENT ADD CONSTRAINT STOCK_EVENT_FK11 FOREIGN KEY (SUPPLIER_ID) REFERENCES SUPPLIER(SUPPLIER_ID);
go
