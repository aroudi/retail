...
CREATE TABLE PURCHASE_LINE(
    ...
    POL_MODIFIED datetime NOT NULL,
    ...
    POL_CONTENTS DECIMAL(31,4),
    UNOM_ID_CONTENTS DECIMAL(31,0),
...
ALTER TABLE PURCHASE_LINE ADD CONSTRAINT PL_FK7 FOREIGN KEY (POL_ID_PARENT_LINE) REFERENCES PURCHASE_LINE(POL_ID);
go
