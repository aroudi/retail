...
( NAME = N'RETAIL_Data', FILENAME = N'/var/retail-data/RETAIL.mdf' , SIZE = 6528KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
 LOG ON
( NAME = N'RETAIL_Log', FILENAME = N'/var/retail-data/RETAIL.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
